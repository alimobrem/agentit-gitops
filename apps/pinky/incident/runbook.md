# Incident Response Runbook — pinky

## Triage Steps

1. Confirm the alert source and affected service.
2. Verify pod status: `kubectl get pods -l app=pinky`
3. Check recent logs: `kubectl logs -l app=pinky --tail=100`
...
1. Rolling restart: `kubectl rollout restart deployment/pinky`
2. Scale up: `kubectl scale deployment/pinky --replicas=3`
3. Rollback: `kubectl rollout undo deployment/pinky`
